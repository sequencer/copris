...
import sugar.csp.BooleanLiteral;
import sugar.csp.BooleanVariable;
import sugar.csp.CSP;
import sugar.csp.CSP.Objective;
import sugar.csp.Clause;
import sugar.csp.HoldLiteral;
import sugar.csp.IntegerDomain;
import sugar.csp.IntegerVariable;
import sugar.csp.LinearEqLiteral;
import sugar.csp.LinearGeLiteral;
import sugar.csp.LinearLeLiteral;
import sugar.csp.LinearLiteral;
import sugar.csp.LinearNeLiteral;
import sugar.csp.LinearSum;
import sugar.csp.Literal;
import sugar.csp.PowerLiteral;
import sugar.csp.ProductLiteral;
import sugar.csp.Relation;
import sugar.csp.RelationLiteral;
import sugar.expression.Expression;
import sugar.expression.Sequence;
...
public class Output implements OutputInterface {
    ...
    public void setFormat(String format) throws SugarException {
        if (format == null || format.equals("sugar/csp")) {
